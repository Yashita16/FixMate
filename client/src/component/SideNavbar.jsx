  ...
  return (
    <div className='w-[70px] sm:w-[160px] md:w-[180px] lg:w-[200px] min-h-screen bg-white shadow-md border-r border-gray-200 flex flex-col  '>
      ...
      <div className='flex flex-col h-[88vh] justify-between'>
        ...
        <Link className='hover:text-primary-blue' >Report Issue</Link>
        <Link className='hover:text-primary-blue' >Previous Issues</Link>
        <Link className='hover:text-primary-blue' >Log Out</Link>
       </div>
